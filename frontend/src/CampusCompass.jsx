...
export default function CampusCompass() {
  ...
  const getApiUrl = () => {
    ...
    // In production (not dev mode), use same origin (relative URL)
    // This works when frontend is served from the same domain as backend
    if (!import.meta.env.DEV) {
      // Use relative URL - works when served from same domain
